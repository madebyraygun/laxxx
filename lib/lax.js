...
(function () {
  var lax = function () {
    ...
    var transformFns = {
      ...
      "data-lax-fill-opacity": function dataLaxFillOpacity(style, v) {
        style.fillOpacity = v;
      },
    ...
    lax.updateElement = function (o) {
      ...
      for (var _i5 in transforms) {
        ...
        var easing = transformData.options.easing ? transformData.options.easing : false;
        var t = transformFns[_i5];
        var v = intrp(transformData.valueMap, _r, easing);
